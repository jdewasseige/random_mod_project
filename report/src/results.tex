...
\begin{changemargin}{-0.5cm}{2cm} % nb_turns simple and hotels  (fold)
  ...
  \noindent\centering
    \begin{minipage}{0.7\linewidth}
     ...
     \end{tabular}
     % \begin{flushleft}
       \captionof{table}{Number of turns to equalize \\rent and cost for \emph{simple} rent.}
    ...
    \begin{minipage}{0.5\linewidth}
       ...
       \end{tabular}
     %\begin{flushleft}
       \captionof{table}{Number of turns to equalize rent and cost for \emph{hotel} rent.}
  ...
  \noindent\centering
    \begin{minipage}{0.61\linewidth}
      \begin{center}
        ...
        \end{tabular}
        % \begin{flushleft}
          \captionof{table}{\emph{Ordered} fields by number\\ of turns needed to equalize rent
          and\\ cost for \emph{simple} rent.}
